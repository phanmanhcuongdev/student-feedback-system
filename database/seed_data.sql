...
INSERT INTO [dbo].[Survey] ([survey_id], [title], [description], [start_date], [end_date], [hidden], [created_by]) VALUES
    (1, N'Midterm Teaching Feedback', N'Collect student feedback for the midterm teaching period.', DATEADD(DAY, -3, GETDATE()), DATEADD(DAY, 7, GETDATE()), 0, 1),
    (2, N'Lab Session Feedback', N'Give feedback on the current lab sessions.', DATEADD(DAY, -1, GETDATE()), DATEADD(HOUR, 18, GETDATE()), 0, 1),
    (3, N'Final Course Feedback', N'This survey opens soon for final course feedback.', DATEADD(DAY, 2, GETDATE()), DATEADD(DAY, 9, GETDATE()), 0, 1),
    (4, N'Workshop Feedback', N'This workshop survey recently closed.', DATEADD(DAY, -5, GETDATE()), DATEADD(DAY, -1, GETDATE()), 0, 1);
