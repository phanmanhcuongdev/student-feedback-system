...
![TODO: System Architecture Diagram tổng thể](assets/system-architecture.png)

> [Hình 3.1: TODO - System Architecture Diagram tổng thể gồm browser, frontend, reverse proxy, backend, database và external services]
...
![TODO: Backend Hexagonal Architecture Diagram](assets/backend-hexagonal-architecture.png)

> [Hình 3.2: TODO - Sơ đồ backend Ports and Adapters / Hexagonal Architecture]
...
![TODO: Frontend Architecture Diagram](assets/frontend-architecture.png)

> [Hình 3.3: TODO - Frontend Architecture Diagram mô tả React SPA, router, providers, API layer và feature modules]
...
![TODO: Containerization Diagram](assets/containerization-diagram.png)

> [Hình 5.1: TODO - Sơ đồ container hóa frontend/backend và luồng proxy `/api` qua Nginx]
...
![TODO: CI/CD Pipeline Diagram](assets/cicd-pipeline.png)

> [Hình 5.2: TODO - CI/CD Pipeline Diagram gồm quality gate, image build, image scan và push GHCR]
...
![TODO: GitHub Actions Pipeline Passed](assets/github-actions-passed.png)

> [Hình 9.2: TODO - Screenshot GitHub Actions pipeline passed]
...
![TODO: Portainer/Docker Stack Running](assets/portainer-stack.png)

> [Hình 9.3: TODO - Portainer/Docker Stack Running, thể hiện backend/frontend container đang chạy]
...
![TODO: Docker/Portainer Stack](assets/demo-portainer-stack.png)

> [Hình 10.11: TODO - Docker/Portainer Stack, thể hiện backend/frontend container đang chạy]

![TODO: GitHub Actions Pipeline](assets/demo-github-actions.png)

> [Hình 10.12: TODO - GitHub Actions Pipeline, thể hiện quality gate, Docker build và scan passed]

![TODO: GHCR Images](assets/demo-ghcr-images.png)

> [Hình 10.13: TODO - GHCR Images, thể hiện backend/frontend image tags]

![TODO: Nginx Proxy Public Domain](assets/demo-nginx-proxy.png)

> [Hình 10.14: TODO - Nginx Proxy Public Domain, thể hiện domain public trỏ qua Nginx reverse proxy]
...
> [Hình 10.15: TODO - Proxmox Overview, thể hiện node/VM/container liên quan hệ thống]

![TODO: Headscale Nodes](assets/demo-headscale-nodes.png)

> [Hình 10.16: TODO - Headscale Nodes, thể hiện Tailnet nodes và tags]

![TODO: CrowdSec Decisions](assets/demo-crowdsec-decisions.png)

> [Hình 10.17: TODO - CrowdSec Decisions, thể hiện quyết định ban IP hoặc phát hiện probing]

![TODO: Public Ports Check](assets/demo-public-ports.png)

> [Hình 10.18: TODO - Public Ports Check, thể hiện chỉ 80/443 public và không public SSH/DB/RabbitMQ/MinIO]
...
> [Hình 10.19: TODO - Grafana Node Exporter Dashboard, thể hiện CPU/RAM/Disk/Network/Uptime]

![TODO: Prometheus Targets](assets/demo-prometheus-targets.png)

> [Hình 10.20: TODO - Prometheus Targets, thể hiện target `up == 1`]

![TODO: Loki Panel](assets/demo-loki-panel.png)

> [Hình 10.21: TODO - Loki Panel, thể hiện log observation nếu đã có log pipeline]

![TODO: Telegram Alert](assets/demo-telegram-alert.png)

> [Hình 10.22: TODO - Telegram Alert, thể hiện contact point hoặc alert notification nếu có bằng chứng]
...
- [ ] CrowdSec ban IP.
- [ ] UI screenshots.
- [ ] Portainer/Docker stack screenshots.
...
| Tên ảnh | File path đề xuất | Mục trong báo cáo | Nội dung cần thể hiện | Mức ưu tiên |
|---|---|---|---|---|
| System Architecture Diagram tổng thể | `assets/system-architecture.png` | 3.1 | Browser, React SPA, reverse proxy/Nginx, Spring Boot backend, SQL Server, RabbitMQ, MinIO, Resend, AI/embedding. | Bắt buộc |
| Backend Hexagonal Architecture Diagram | `assets/backend-hexagonal-architecture.png` | 3.3 | Adapter in/out, application domain, port in/out, config, infrastructure, persistence/external adapters. | Nên có |
| Frontend Architecture Diagram | `assets/frontend-architecture.png` | 3.5 | React SPA, Router, AuthProvider, NotificationProvider, API layer, feature modules. | Có thì tốt |
...
| Tên ảnh | File path đề xuất | Mục trong báo cáo | Nội dung cần thể hiện | Mức ưu tiên |
|---|---|---|---|---|
| Containerization Diagram | `assets/containerization-diagram.png` | 5.5 | Backend image, frontend image, Nginx serve SPA/proxy `/api`, Docker network. | Bắt buộc |
| CI/CD Pipeline Diagram | `assets/cicd-pipeline.png` | 5.7 | Quality job, backend test, frontend lint/build, Trivy fs scan, Docker build, image scan, push GHCR. | Bắt buộc |
| GitHub Actions Pipeline Passed | `assets/github-actions-passed.png` | 9.6 | Pipeline chạy thành công ở GitHub Actions. | Bắt buộc |
| GitHub Actions Pipeline demo | `assets/demo-github-actions.png` | 10.3 | Bằng chứng pipeline quality gate, Docker build và scan passed. | Nên có |
| GHCR Images | `assets/demo-ghcr-images.png` | 10.3 | Backend/frontend image tags trên GHCR. | Có thì tốt |
| Docker/Portainer Stack Running | `assets/portainer-stack.png` | 9.8 | Backend/frontend container đang chạy. | Nên có |
| Docker/Portainer Stack demo | `assets/demo-portainer-stack.png` | 10.3 | Stack runtime hoặc container status trong Docker/Portainer. | Nên có |
| Nginx Proxy Public Domain | `assets/demo-nginx-proxy.png` | 10.3 | Domain public đi qua Nginx proxy tới frontend production. | Nên có |
